			...
			<div id="content">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --><i class="fa-fw fa fa-puzzle-piece"></i> Instructors <span>>
							Profile </span></h1>
					</div>
					<!-- end col -->
											...
											<div class="row">
												...
												<div class="col-sm-12">
													...
													<div class="row">
														...
														<div class="col-sm-9">
															<h1>Jennifer <span class="semi-bold">Lopez</span>
															<br>
															<small> Board of Directors, uPace</small></h1>
				
															<ul class="list-unstyled">
																<li>
																	<p class="text-muted">
																		<i class="fa fa-phone"></i>&nbsp;&nbsp;(<span class="txt-color-darken">313</span>) <span class="txt-color-darken">987</span> - <span class="txt-color-darken">6543210</span>
																	</p>
																</li>
																<li>
																	<p class="text-muted">
																		<i class="fa fa-envelope"></i>&nbsp;&nbsp;<a href="mailto:jeniffer.lopez@upace.com">jeniffer.lopez@upace.com</a>
																	</p>
																</li>
															</ul>
															<br>
															...
															<br>
															<a href="mailto:jeniffer.lopez@upace.com" class="btn btn-default btn-xs"><i class="fa fa-envelope-o"></i> Send Message</a>
															<br>
															<br>
															<div class="col-sm-6">
															<form class="smart-form">
																		<div class="rating">
																			...
																			<input type="radio" name="stars-rating" id="stars-rating-4" checked="true">
