   ...
   Parse.initialize("<?php echo API;?>", "<?php echo JSKEY;?>");
    ...
    Parse.User.logIn(username, password, {
		  success: function(user) {
		    ...
		    {
		    		if((userType=='staff' || userType=='manager' || userType=='instructor'))
					{
						var staff = Parse.Object.extend('gym_staff');
						var eqpmnts = new Parse.Query(staff);
						eqpmnts.equalTo('email',user.get('email'));
						eqpmnts.equalTo('gymId',user.get('universityGymId'));
