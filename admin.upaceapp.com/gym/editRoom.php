						...
						<form id="room-register" class="smart-form">
							...
							<fieldset>
								...
								<div class="row">
									...
									<!--<section class="col col-6">
										<label class="input">
											<input type="text" name="reservedOccupancy" onkeypress="return checkNumber(event)" placeholder="Reserved Occupancy" id="reservedOccupancy" />
										</label>
									</section>-->
									</div>
									<div class="row">                   
									...
									<div class="row map_image_div" style="display:none;">  
										<section class="col col-6">
											<img src="" width="300">
										</section>
									</div>
...
<!-- end widget grid -->
		...
		$(document).ready(function() {
			roomDetails('<?php echo (!empty($_REQUEST['rid'])?$_REQUEST['rid']:''); ?>');
