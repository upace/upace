...
<body>
    <section class="login-bg register_page">
        <div class="" id="terms_div" style="display:none;">
            <div class="container">
            		<a class="pull-right terms_close_button" href="#" id="">
    		...
    		<div class="search_auto_head">
    			<div class="inner_width_srch">
    				<div class="srch_text_left">
    					<input type="text" value="Georg"/>
    					<a href=""><img src="img/srch_auto.png" alt="" class="srch_auto"></a>
    					<a href=""><img src="img/clos_auto.png" alt="" class="clos_auto"></a>
    				</div>
    				<a href="" class="srch_text_close">CLOSE</a>
    			</div>
    		</div>
            <ul class="uni-list">
...
<!--                <label>
                ...
                <div class="university">
                    <input type="text" name="university_text" id="university_text">
...
<!--                   <label><input type="text" placeholder="Gym Frequency" name="gymFrequency" id="gymFrequency"></label>-->
                   ...
                   <label>
                       <select name="gymFrequency" id="gymFrequency" >
                        ...
                        <label><input type="text" placeholder="Create User Name" name="username" id="username" onkeypress="return disable_space(event);" class="gray_light"></label>
...
you are accepting our <a href="">terms</a></p>
