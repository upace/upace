										...
										<table id="example" class="display projects-table table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									        ...
									        <tbody>
												<tr class="odd" role="row">
													<td class=" details-control"  onClick="showlist('#1')"></td>
													<td class="sorting_1">
														Treadmill
														<br>
														<small class="text-muted">
															<i>
															About Treadmill Equipment
															<i></i>															</i>														</small>													</td>
													<td>
														Room1													</td>
													<td>
												...
												<tr class="odd" role="row" id="1"  style="display:none">
													<td class=" details control" onClick="closelist('#1')"><i class="fa fa-lg fa-fw fa-minus-circle"></i></td>
													<td class="sorting_1">
														<input type="text" value="Treadmill" style="    width: 100%;">
													</td>
													<td>
														<select name="location" style="    width: 100%;">
															<option value="0" selected="" disabled="">select location</option>
															<option value="1" selected="selected">Room1</option>
															<option value="2">Room2</option>
														</select>													</td>
													<td>
														<select name="advance_signup_limit"> style="    width: 100%;"
															...
															<option value="5">24 Hour</option>
														</select>													</td>
													<td>
														<select name="machine_time_limit" style="    width: 100%;">
															<option value="0" selected="" disabled="">Select Machine Time Limit</option>
															<option value="2" selected="selected">1 hour</option>
															<option value="3">45 minutes</option>
															<option value="4">30 minutes</option>
														</select>													</td>
													<td>
														<select name="signup_limit" style="    width: 100%;">
															<option value="0" selected="" disabled="">Select Sign Up Limit</option>
															<option value="1">No Limit</option>
															<option value="2" selected="selected">3 Reservations Per day</option>
															<option value="3">2 Reservations Per day</option>
															<option value="4">1 Reservations Per day</option>
														</select>													</td>
													<td>
														<span class="onoffswitch">
															<i class="fa fa-lg fa-fw fa-check-square-o" title="Save"></i>
															<i class="fa fa-lg fa-fw fa-minus-circle" title="Delete"></i>														</label>
														</span>
													</td>
												</tr>
												<tr class="even" role="row">
													<td class=" details-control"  onClick="showlist('#2')"></td>
													<td class="sorting_1">
														Bicycle
														<br>
														<small class="text-muted">
													...
													<td>
														45 minutes													</td>
													<td>
														1 reservation per day													</td>
													<td>
														<span class="onoffswitch">
															<input id="st11" class="onoffswitch-checkbox" type="checkbox" name="start_interval" checked="checked">
															<label class="onoffswitch-label" for="st11">
																<span class="onoffswitch-inner" data-swchoff-text="OFF" data-swchon-text="ON"></span>
																<span class="onoffswitch-switch"></span>															</label>
														</span>													</td>
												</tr>
												<tr class="even" role="row" id="2" style="display:none">
													<td class=" details control" onClick="closelist('#2')"><i class="fa fa-lg fa-fw fa-minus-circle"></i></td>
													<td class="sorting_1">
														<input type="text" value="Bicycle " style="    width: 100%;">
													</td>
													<td>
														<select name="location" style="    width: 100%;">
															<option value="0" selected="" disabled="">select location</option>
															<option value="1">Room1</option>
															<option value="2" selected="selected">Room2</option>
														</select>													</td>
													<td>
														<select name="advance_signup_limit"> style="    width: 100%;"
															<option value="0" selected="" disabled="">Select Advance Signup Limit</option>
															<option value="1">No Limit</option>
															<option value="2" selected="selected">1 Month</option>
															<option value="3">2 Weeks</option>
															<option value="4">1 Week</option>
															<option value="5">24 Hour</option>
														</select>													</td>
													<td>
														<select name="machine_time_limit" style="    width: 100%;">
															...
															<option value="3" selected="selected">45 minutes</option>
															<option value="4">30 minutes</option>
														</select>													</td>
													<td>
														<select name="signup_limit" style="    width: 100%;">
															<option value="0" selected="" disabled="">Select Sign Up Limit</option>
															<option value="1">No Limit</option>
															<option value="2">3 Reservations Per day</option>
															<option value="3">2 Reservations Per day</option>
															<option value="4" selected="selected">1 Reservations Per day</option>
														</select>													</td>
													<td>
														<span class="onoffswitch">
															<i class="fa fa-lg fa-fw fa-check-square-o" title="Save"></i>
