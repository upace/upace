							...
							<fieldset>
								<section class="col col-9">
									<div class="form-group">
										<label class="control-label col-md-2" for="prepend">Facebook url</label>
										<div class="col-md-10">
											<div class="icon-addon addon-md">
							                    <input type="text" placeholder="Facebook url" class="form-control">
							                    <label for="facebook_url" class="fa fa-facebook" rel="tooltip" title="facebook url"></label>
							                </div>
										</div>
									</div>
									</section>
									<section class="col col-9">
									<div class="form-group">
										<label class="control-label col-md-2" for="prepend">Twitter url</label>
										<div class="col-md-10">
											<div class="icon-addon addon-md">
							                    <input type="text" placeholder="Twitter url" class="form-control">
							                    <label for="twitter_url" class="fa fa-twitter" rel="tooltip" title="twitter url"></label>
							                </div>
										</div>
									</div>
									</section>
									<section class="col col-9">
									<div class="form-group">
										<label class="control-label col-md-2" for="prepend">Google+ url</label>
										<div class="col-md-10">
											<div class="icon-addon addon-md">
							                    <input type="text" placeholder="Google+ url" class="form-control">
							                    <label for="googleplus_url" class="fa fa-google" rel="tooltip" title="google+ url"></label>
							                </div>
										</div>
									</div>
									</section>
									<section class="col col-9">
									<div class="form-group">
										<label class="control-label col-md-2" for="prepend">Youtube url</label>
										<div class="col-md-10">
											<div class="icon-addon addon-md">
							                    <input type="text" placeholder="Youtube url" class="form-control">
							                    <label for="youtube_url" class="fa fa-youtube" rel="tooltip" title="youtube url"></label>
							                </div>
										</div>
									</div>
									</section>
									<section class="col col-9">
									<div class="form-group">
										<label class="control-label col-md-2" for="prepend">Instagram url</label>
										<div class="col-md-10">
											<div class="icon-addon addon-md">
							                    <input type="text" placeholder="Instagram url" class="form-control">
							                    <label for="instagram_url" class="fa fa-instagram" rel="tooltip" title="instagram url"></label>
							                </div>
										</div>
									</div>
									</section>
