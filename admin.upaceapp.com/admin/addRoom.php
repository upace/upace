			...
			if(!login_count)
			{
				var tour = new Tour({
					steps: [
						{
							element: "#my-element",
							title: "Second Step Add Room",
							content: "You have to Add Room"
						}
					],
					template: "<div class='popover tour'><div class='arrow'></div><h3 class='popover-title'>Second Step Add Room</h3><div class='popover-content'>You have to Add Room</div><div class='popover-navigation'></div></nav></div>"
				});
				tour.init();
				tour.start();
			}
