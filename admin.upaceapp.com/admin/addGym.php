                              ...
                              <fieldset class="time_fields">
								    ...
								    <section class="col col-6">
		 								<label class="input">Sunday
											<input type="text" placeholder="Start Time" name="start_time0" id="start_time0" class="start_time" value="9:00 AM">
										</label>
                                    </section>
								    <section class="col col-6">
									    <label class="input">Sunday
											<input type="text" placeholder="End Time" name="end_time0" id="end_time0" class="end_time" value="5:00 PM">
									    </label>
								    </section>
                                  </div>
								  ...
								  <div class="row">
								    <section class="col col-6">
		 								<label class="input">Monday
											<input type="text" placeholder="Start Time" name="start_time1" id="start_time1" class="start_time" value="9:00 AM">
										</label>
                                    </section>
								    <section class="col col-6">
									    <label class="input">Monday
											<input type="text" placeholder="End Time" name="end_time1" id="end_time1" class="end_time" value="5:00 PM">
									    </label>
								    </section>
                                  </div>
								  ...
								  <div class="row">
								    <section class="col col-6">
		 								<label class="input">Tuesday
											<input type="text" placeholder="Start Time" name="start_time2" id="start_time2" class="start_time" value="9:00 AM">
										</label>
                                    </section>
								    <section class="col col-6">
									    <label class="input">Tuesday
											<input type="text" placeholder="End Time" name="end_time2" id="end_time2" class="end_time" value="5:00 PM">
									    </label>
								    </section>
                                  </div>
								  ...
								  <div class="row">
								    <section class="col col-6">
		 								<label class="input">Wednesday
											<input type="text" placeholder="Start Time" name="start_time3" id="start_time3" class="start_time" value="9:00 AM">
										</label>
                                    </section>
								    <section class="col col-6">
									    <label class="input">Wednesday
											<input type="text" placeholder="End Time" name="end_time3" id="end_time3" class="end_time" value="5:00 PM">
									    </label>
								    </section>
                                  </div>
								  ...
								  <div class="row">
								    <section class="col col-6">
		 								<label class="input">Thursday
											<input type="text" placeholder="Start Time" name="start_time4" id="start_time4" class="start_time" value="9:00 AM">
										</label>
                                    </section>
								    <section class="col col-6">
									    <label class="input">Thursday
											<input type="text" placeholder="End Time" name="end_time4" id="end_time4" class="end_time" value="5:00 PM">
									    </label>
								    </section>
                                  </div>
								  ...
								  <div class="row">
								    <section class="col col-6">
		 								<label class="input">Friday
											<input type="text" placeholder="Start Time" name="start_time5" id="start_time5" class="start_time" value="9:00 AM">
										</label>
                                    </section>
								    <section class="col col-6">
									    <label class="input">Friday
											<input type="text" placeholder="End Time" name="end_time5" id="end_time5" class="end_time" value="5:00 PM">
									    </label>
								    </section>
                                  </div>
								  ...
								  <div class="row">
								    <section class="col col-6">
		 								<label class="input">Saturday
											<input type="text" placeholder="Start Time" name="start_time6" id="start_time6" class="start_time" value="9:00 AM">
										</label>
                                    </section>
								    <section class="col col-6">
									    <label class="input">Saturday
											<input type="text" placeholder="End Time" name="end_time6" id="end_time6" class="end_time" value="5:00 PM">
									    </label>
								    </section>
                                  </div>                 
                            </fieldset>
	...
	if(!login_count)
	{
		var tour = new Tour({
			steps: [
				{
					element: "#my-element",
					title: "First Step Add Gym",
					content: "You have to Add Gym"
				}
			],
			template: "<div class='popover tour'><div class='arrow'></div><h3 class='popover-title'>First Step Add Gym</h3><div class='popover-content'>You have to Add Gym</div><div class='popover-navigation'></div></nav></div>"
		});
