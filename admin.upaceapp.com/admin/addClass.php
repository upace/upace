											...
											<div class="form-group">
												...
												<section class="smart-form">
													<label class="select state-success">
														<select name="gym" id="gym" onchange="get_instructor_list(this.value);get_rooms_list(this.value)">
		...
		$(document).ready(function() {
			...
			var slot_count = 2;
			   ...
			   if ($('#add-event-form').valid()) {
				...
				calenderClass('<?php echo ROOT?>admin/');
			...
			if(!login_count)
			{
				var tour = new Tour({
					steps: [
						{
							element: "#my-element",
							title: "Fourth Step Add Class",
							content: "You have to Add Class",
							enabled: true,
							redirect: true,
							template: "<div class='popover tour'><div class='arrow'></div><h3 class='popover-title'>Fourth Step Add Class</h3><div class='popover-content'>You have to Add Class</div><div class='popover-navigation'><button class='btn btn-default next_btn' data-role='next'>Skip »</button></div></nav></div>",
							onNext: function(){
								document.location.href = '<?php echo ROOT?>admin/addEquipments';
