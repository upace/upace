<!-- PACE LOADER - turn this on if you want ajax loading to show (caution: uses lots of memory on iDevices)-->
		...
		<!--         Notifybar       -->
                ...
                <script src="<?php echo ROOT;?>js/bootstrap-tour-standalone.min.js"></script>
                <link href="<?php echo ROOT?>css/bootstrap-tour-standalone.min.css" rel="stylesheet">
...
$(document).ready(function() {
	...
	u.equalTo('universityId', current.get('universityId'));
