...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown">
		...
		<header id="header">
			...
			<div id="logo-group">
				<a href="/"><span id="logo"> <img src="img/logo.png" alt="uPace"> </span>			</div></a>

			<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Need an account?</span> <a href="register" class="btn btn-danger">Create account</a> </span>		</header>
					...
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
						...
						<div class="hero">
							...
							<div class="pull-left login-desc-box-l">
								...
								<div class="login-app-icons">
									...
									<a href="javascript:void(0);" class="btn btn-danger btn-sm">Lorem ipsum</a>								</div>
							</div>
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								<h5 class="about-heading">About uPace - Are you up to date?</h5>
								<p>
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						...
						<!--<h5 class="text-center"> - Or sign in using -</h5>
							...
							<ul class="list-inline text-center">
								<li>
									<a href="javascript:void(0);" class="btn btn-primary btn-circle"><i class="fa fa-facebook"></i></a>								</li>
								<li>
									<a href="javascript:void(0);" class="btn btn-info btn-circle"><i class="fa fa-twitter"></i></a>								</li>
								<li>
									<a href="javascript:void(0);" class="btn btn-warning btn-circle"><i class="fa fa-linkedin"></i></a>								</li>
							</ul>-->
					</div>
				</div>
			</div>
