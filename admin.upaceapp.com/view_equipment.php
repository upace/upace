    ...
    <div class="container">
    	<div class="poweryoga">
        	<div class="col-lg-10 col-md-10 col-sm-10 equip-div">
                ...
                <h3 class="yellow_text">Current Status : <span></span></h3>
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 rererico">
            	<img alt="" src="img/close_sign.png" onclick="window.location='<?php echo ROOT; ?>equipment'">
...
<!--                <a href=""><i class="fa fa-heart fa-3x"></i></a>
                <a href=""><i class="fa fa-share-alt fa-3x"></i></a>-->
            </div>
            <div class="clearfix"></div>
			<div class="col-lg-12 col-md-12 col-sm-12"> 
                <a href="javascript:void(0);" role="button" class="btn common_cancl_btn margin_minus cancel_res" style="display:none;" onclick="delete_occupancy()">CANCEL RESERVATION</a>
                <a href="javascript:void(0);" role="button" class="btn common_cancl_btn margin_minus save_res" onclick="save_res()" style="display:none;">SAVE RESERVATION</a>
                <a href="javascript:void(0);" role="button" class="btn common_cancl_btn margin_minus notify_res" onclick="notify_res()" style="display:none;">NOTIFY ME IF AVAILABLE</a>
            </div>
        ...
        <input type="hidden" name="rootUrl" id="rootUrl" value="<?php echo $ROOT; ?>">
...
<script src="//connect.facebook.net/en_US/all.js"></script>
    <script>
        ...
        get_occupancy_details('<?php echo $_REQUEST['slot']; ?>');
		 ...
		 function fav_class()
        {
            ...
            r.id = user.id;
            if(user.get('fav_equip'))
            {
                r.set("fav_equip", "," + $('#equip').val());
            }
            else
            {
                r.set("fav_equip", $('#equip').val());
            ...
            if(confirm('Are you sure you want to remove from favourite?'))
            {
                ...
                UA.first({
                    success:function(curUser){
                        var r = Parse.Object('User');
                        r.id = user.id;
                        isFav=curUser.get('fav_equip');
                        if(isFav)
                        {
                            r.set("fav_equip", isFav.replace($('#equip').val(),''));
                        }
