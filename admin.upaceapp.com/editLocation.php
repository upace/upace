	...
	<body class="">
		...
		<div id="main" role="main">
			...
			<div id="ribbon">
				...
				<span id="add" class="btn btn-ribbon hidden-xs" data-title="add"><i class="fa-plus"></i> Edit</span>
					...
					<div class="widget-body no-padding">
						...
						<form id="smart-form-register" class="smart-form">
							...
							<fieldset>
									<section>
										<label class="input">
											<input type="text" name="equipmentname" placeholder="Location Name" value="USA">
										</label>
									</section>
									<section>
										<label for="address2" class="input">
											<input type="text" name="address2" id="address2" placeholder="Address" value="69 Street">
										</label>
									</section>
									<div class="row">
									...
									<section class="col col-4">
										<label class="input">
											<input type="text" name="city" placeholder="City" value="Basalt">
										</label>
									</section>
									...
									<section class="col col-3">
										<label class="input">
											<input type="text" name="code" placeholder="Post code" value="81621">
										</label>
									</section>
