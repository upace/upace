   ...
   FB.login(function(response){
    ...
    if(!response || response.status !== 'connected') {
     ...
     FB.api('/me', function(fbdata){      
      ...
      jQuery('#fbId').val(fb_user_id);
      jQuery('#firstName').val(fb_first_name);
      jQuery('#lastName').val(fb_last_name);
      jQuery('#email').val(fb_email);
      jQuery('#auth').val(fbdata);
     })
    }
   }, {scope:"email"});
    })
    ...
    <section class="login-bg register_page">
		<div class="overlay page-gym1" style="display:none;">
                <div class="container">
                     <div class="login-pg signup-pg te rms">
                          <div class="row">
                               <div class="col-lg-12">
							   <a class="cancel cancel-page-gym2" href="javascript:void(0);" style="float:right" ><img alt="" src="img/cancel.png"></a>
                                    <h1><div class="terms_text" style="height: 550px;overflow-y: scroll;width: 100%;text-align: initial;line-height: 1.52;">Mobile Application Terms of Use
...
We reserve the right to change the terms of this Mobile Privacy Policy from time to time.</div>
</h1><br>
        ...
        <div class="" id="terms_div" style="display:none;">
            <div class="container">
            		<a class="pull-right terms_close_button" onclick="$('#terms_div').hide();" href="javascript:void(0);" id="">
                    ...
                    <div class="row">
                            <div class="col-lg-12">
                                <h1>TERMS OF USE</h1>
                                <p>Mobile Application Terms of Use
...
We reserve the right to change the terms of this Mobile Privacy Policy from time to time.
                    ...
                    <div class="row">
                            <div class="col-lg-12">
                            <a href="javascript:void(0);" class="signup" id="accept_terms">Accept</a>
                        </div>
                    </div>
                    </div>
            </div>
    ...
    <!-- Page Content -->
    <div class="container">
    	<div class="university-down" id="university-down" style="display:none;">
    		<div class="search_auto_head">
    			<div class="inner_width_srch">
    				<div class="srch_text_left">
    					<input type="text" value="" class="uni_serchtext"/>
    					<a href="javascript:void(0);"><img src="img/srch_auto.png" alt="" class="srch_auto"></a>
    					<a href="javascript:void(0);" class="clear_uni_serchtext"><img src="img/clos_auto.png" alt="" class="clos_auto"></a>
    				</div>
    				<a href="javascript:void(0);" class="srch_text_close uni-search-close">CLOSE</a>
    			</div>
    		</div>
            <ul class="uni-list">
<!--                      <li><a href="#">Gorgetown University</a>
                <ul class="uni-sub-list">
                  <li><span>Select your primary gym...</span></li>
                  <li><a href="#">Gorge gym</a></li>
                  <li><a href="#">Smith gym</a></li>
                  <li><a href="#">Gorge gym</a></li>
                  <li><a href="#">Smith gym</a></li>                 
                  <li><a href="#">Gorge gym</a></li>
                  <li><a href="#">Smith gym</a></li>
              ...
              <li><a href="#">Gorgetown University</a></li>
              <li><a href="#">Gorgetown University</a></li>
              <li><a href="#">Gorgetown University</a></li>
              <li><a href="#">Gorgetown University</a></li>
              <li><a href="#">Gorgetown University</a></li>
        ...
        <div class="login-pg signup-pg">
        	<h1>SIGN UP</h1>
        	<a onClick="" class="sign_cancel" href="/login"><img alt="" src="img/close_sign.png"></a>
            <div class="clearfix"></div>
            <div class="social-btn">
            	<div class="facebook"><input type="button" value="FACEBOOK" id="flogin" class="button flogin"></div>
            ...
            <input type="hidden" name="twtId" id="twtId" />
<!--                <div class="university"><a href=""><i class="fa fa-search"></i></a>
                </div>-->
<!--                <label>
                ...
                <div class="university">
                    <input type="text" name="university_text" id="university_text" placeholder="University">
                    <input type="hidden" name="university" id="university">
                    <input type="hidden" name="gym" id="gym">
...
<!--                    <select name="gym" id="gym" >
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 pull-left">
                        <label class="gender-label"><input type="text" value="Male" class="gender" id="male" style="cursor:pointer" readonly></label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 pull-right">
                        <label class="gender-label"><input type="female" value="Female" name="gender" id="female" style="cursor:pointer" readonly></label>
                    </div>
                </div> 
                <!--  <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 pull-left">
...
<!--                   <label><input type="text" placeholder="Member Type" name="memberType" id="memberType"></label>-->
                    ...
                    <label>
                       <select name="memberType" id="memberType" placeholder="NNN" >
					   		 <option disabled="disabled" selected="selected" style="display:none">Member Type</option>
...
<!--                   <label><input type="text" placeholder="Gym Frequency" name="gymFrequency" id="gymFrequency"></label>-->
                  
                   <label>
                       <select name="gymFrequency" id="gymFrequency" >
                             <option value="" disabled="disabled" selected="selected" style="display:none">Gym Frequency</option>
                             <option value="Never">Never</option>
                             <option value="Every once and a while">Every once and a while</option>
                             <option value="Once a week">Once a week</option>
                             <option value="Almost daily">Almost daily</option>
                       </select>
                    </label>
                    
                        <label><input type="text" placeholder="Create Username" name="username" id="username" onKeyPress="return disable_space(event);" class="gray_light"></label>
                   
                        <label>
                            <input type="password" placeholder="Create Password" name="password" id="password" class="gray_light">
                        </label>
                    
<!--                    <input type="button" class="signup" value="Signup">-->
                    <input type="button" value="SUBMIT" class="signup" id="signup" />
                    <p class="terms">By clicking the submit button,<br/> 
you are accepting our <a href="javascript:void(0);" class="openterms">terms</a></p>
    ...
    <script type="text/javascript" src="<?php echo ROOT?>js/site.js"></script>
		...
		$(document).ready(function() {
			 $('.openterms').on('click',function()
			{
			 ...
			 $('.cancel-page-gym2').on('click',function(){
					$('.page-gym1').hide(400);
			});
			//pageSetUp();
			var validateError = 0;
			...
			var $registerForm = $("#loginForm").validate({
				...
				messages : {
                                        university_text : { required : 'Please select University and Gym' },
					...
					password : { required : 'Please enter Password' },
                                        gym : { required : 'Please select gym.' }
				},
			   ...
			   if ($('#loginForm').valid()) {
				 ...
				 //register(form);
                    ...
                    $('#accept_terms').click(function(){
                        $('#terms_div').fadeOut(500);
                        var form = $( "form" ).serializeArray();
                        register(form);
                    });
                    
                    $('#university_text').on('focus',function(){
                        
                        $('#university-down').show();
                    });
                    
                    $('#university').blur(function(){
                        //$('#university-down').hide();
                    });
                    
                    $('.uni-search-close').on('click',function(){
                        $('#university-down').hide(400);
                    })
                    
                    $('.clear_uni_serchtext').on('click',function(){
                        $('.uni_serchtext').val('');
                        $(".uni-list li").show();
                    })
                    
                    $(".uni_serchtext").keyup(function () {
                        var filter = $(this).val();
                        //alert(filter);
                        $(".uni-list li").each(function () {
                   ...
                   $('.gender-label').on('click',function(){
                       ...
                       $('.gender-label').find('input').removeClass('gray_light');
                       $(this).find('input').addClass('gray_light');
                       document.getElementById('memberType').focus();
                   });
	
		})

                function disable_space(e)
                {
                    if(e.which==32)
                    {
                        return false;
                    ...
                    q.find({
                        success: function(results){
                            for(i in results){
                                ...
                                $(".uni-list").prepend("<li><a href='javascript:void(0);' class='unia' onclick=\"signup_gyms('" + university.id + "',this)\" >" + university.get('name') + "</a></li>");
                                //$(".uni-list").append(new Option(university.get('name'), university.id));
                           }
                        }
                    });
                }
                
                function signup_gyms(universityId,elem)
                {
                    ...
                    q.find({
                        success: function(results){
                            ...
                            //$('.uni-sub-list').hide();
                            $('.uni-sub-list').hide();
                            if($(elem).closest('li').find('.uni-sub-list').length)
                            {
                                $(elem).closest('li').find('.uni-sub-list').toggle(400);
                            }
                            else
                            {
                                if(results)
                                {
                                    uni_sub_list_ul = '<ul class="uni-sub-list">';
                                    for(i in results){
                                        var gym = results[i];
                                        var university = results[i].get('university');
                                        uni_sub_list_ul += '<li><a href="javascript:void(0);" data-gid="'+gym.id+'" onclick="gym_selected(this)" data-uid="'+university.id+'" data-uname="' + university.get('name') + '">' + gym.get('name') + '</li>';
                                        //option = '<option value="'++'">'++'</option>';
                                        //$("#gym").append(new Option(university.get('name'), university.id));
                                    }
                                    uni_sub_list_ul += '</ul>';
                                    $(elem).closest('li').append(uni_sub_list_ul);
                                }
                            }
                        }
                    });
