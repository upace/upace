...
<nav id="sidebar-wrapper">
          <ul class="sidebar-nav">
              ...
              <li>
                  <a href="<?php echo ROOT; ?>myreservations" class="alink"><i class=""><img src="../img/reservation.png" alt="" /></i> Reservations</a>
              </li>
              <li>
                  <a href="<?php echo ROOT; ?>classes"  class="alink"><i class=""><img src="../img/class.png" alt="" /></i> Classes</a>
              </li>
              <li>
                  <a href="<?php echo ROOT; ?>equipment"  class="alink"><i class=""><img src="../img/equipment.png" alt="" /></i> Equipment</a>
              </li>
<!--              <li>
