...
<html lang="en-us">
	<head>
		...
		<!-- Mapplic css for interactive jquery map plugin : floormap -->
			...
			<div id="content">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
						<h1 class="page-title txt-color-blueDark"><i class="fa fa-globe"></i> Floor plan</h1>
					</div>
				</div>
